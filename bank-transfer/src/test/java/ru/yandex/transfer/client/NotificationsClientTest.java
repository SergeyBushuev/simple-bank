...
class NotificationsClientTest {
    ...
    @Test
    void sendNotification_OkTest() throws Exception {
        String login = "alice";
    ...
    @Test
    void sendNotification_ErrorTest() {
        String login = "bob";
        String message = "Test";
        wireMock.stubFor(post(urlPathEqualTo("/api/" + login + "/notifications"))
        ...
        assertThrows(Exception.class, () -> notificationsClient.sendNotification(login, message).block());
    }
}
