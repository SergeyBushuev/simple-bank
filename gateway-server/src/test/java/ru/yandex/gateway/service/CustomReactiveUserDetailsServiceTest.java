package ru.yandex.gateway.service;
...
class CustomReactiveUserDetailsServiceTest {
    ...
    private static final String URL_TEMPLATE =
            "http://bank-accounts/auth/users/{username}";
    ...
    void findByUsername_NotFoundTest() {
        ...
        assertThrows(RuntimeException.class,
                () -> userDetailsService.findByUsername("bob").block());
    }
}
